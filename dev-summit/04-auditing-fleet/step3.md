...
With hooks installed, your machine now continuously reports its AI-tooling inventory back to Obot. In the next step you'll see how the same client forwards **local** MCP audit logs too.
